autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/tau/.config/emacs/elpa/doom-modeline-20200513.1103/doom-modeline-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/tau/.config/emacs/elpa/doom-modeline-20200513.1103/doom-modeline-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/tau/.config/emacs/elpa/counsel-20200520.1809/counsel-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/tau/.config/emacs/elpa/counsel-20200520.1809/counsel-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/tau/.config/emacs/elpa/counsel-projectile-20200520.1422/counsel-projectile-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/tau/.config/emacs/elpa/counsel-projectile-20200520.1422/counsel-projectile-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/tau/.config/emacs/elpa/company-20200510.1614/company-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/tau/.config/emacs/elpa/company-20200510.1614/company-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/tau/.config/emacs/elpa/centaur-tabs-20200511.1242/centaur-tabs-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/tau/.config/emacs/elpa/centaur-tabs-20200511.1242/centaur-tabs-autoloads.el") (car load-path))))
...
(setq package-activated-list
      (append
       '(yasnippet yasnippet-snippets yaml-mode async with-editor which-key web-mode vimrc-mode vi-tilde-fringe popup vc-msg bind-key use-package undo-tree typescript-mode epl pkg-info projectile dash s f avy ace-window pfuture lv hydra ht treemacs treemacs-projectile persp-mode treemacs-persp transient git-commit magit treemacs-magit goto-chg evil treemacs-evil ivy swiper spinner solaire-mode smartparens shrink-path shell-pop scss-mode rotate ranger rainbow-mode rainbow-delimiters prettier-js prescient powerline posframe parent-mode memoize markdown-mode dash-functional lsp-mode lsp-ui loop keyfreq js2-mode ivy-rich ivy-prescient ivy-posframe hl-todo highlight-parentheses highlight-operators highlight-numbers highlight-indent-guides highlight-escape-sequences highlight-defined hide-mode-line elisp-refs helpful haskell-mode goto-line-preview go-mode gitignore-mode gitconfig-mode gitattributes-mode git-timemachine gcmh flycheck flycheck-posframe eyebrowse expand-region exec-path-from-shell evil-magit evil-commentary esup emmet-mode editorconfig dumb-jump drag-stuff doom-themes all-the-icons doom-modeline dockerfile-mode docker-compose-mode dired-k diminish diffview diff-hl counsel counsel-projectile company company-posframe company-lsp company-box centaur-tabs better-jumper auto-package-update amx all-the-icons-ivy all-the-icons-dired aggressive-indent)
...
(progn
  ...
  (setq Info-directory-list
	(append
	 '("/home/tau/.config/emacs/elpa/editorconfig-20200519.1128" "/home/tau/.config/emacs/elpa/haskell-mode-20200408.247" "/home/tau/.config/emacs/elpa/ivy-20200520.1809" "/home/tau/.config/emacs/elpa/evil-20200516.1740" "/home/tau/.config/emacs/elpa/magit-20200517.1537" "/home/tau/.config/emacs/elpa/transient-20200517.2038" "/home/tau/.config/emacs/elpa/dash-20200426.2244" "/home/tau/.config/emacs/elpa/use-package-20200520.2305" "/home/tau/.config/emacs/elpa/with-editor-20200217.1015")
	 Info-directory-list)))

;; Local Variables:
