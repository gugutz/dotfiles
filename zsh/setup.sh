...
wget -o ~/downloads/st-0.8.2/ https://dl.suckless.org/st/st-0.8.2.tar.gz
...
wget -o ~/downloads/st-0.8.2/ https://st.suckless.org/patches/scrollback/st-scrollback-0.8.2.diff
patch -Np1 -i st-scrollback-0.8.2.diff
echo "## downloading and applying mouse scrollback patch (Shift+WheelUp/WheelDown)"
wget -o ~/downloads/st-0.8.2/ https://st.suckless.org/patches/scrollback/st-scrollback-mouse-0.8.2.diff
patch -Np1 -i st-scrollback-mouse-0.8.2.diff
echo "## downloading and applying clipboard patch"
wget -o ~/downloads/st-0.8.2/ https://st.suckless.org/patches/clipboard/st-clipboard-0.8.2.diff
patch -Np1 -i st-clipboard-0.8.2.diff
echo "## downloading and installing rightclickpaste patch"
wget -o ~/downloads/st-0.8.2/ https://st.suckless.org/patches/rightclickpaste/st-rightclickpaste-0.8.2.diff
