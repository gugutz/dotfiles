(custom-set-variables
 ...
 '(flycheck-posframe-warning-prefix "⚠ ")
  '(package-selected-packages
     (quote
       (nyan-mode parrot minions anzu highlight-indent-guides rainbow-mode hl-todo diff-hl highlight-escape-sequences highlight-operators highlight-numbers rainbow-delimiters highlight-parentheses solaire-mode vi-tilde-fringe centaur-tabs yaml-mode emmet-mode prettier-js scss-mode web-mode typescript-mode aggressive-indent editorconfig shell-pop dumb-jump keyfreq which-key helpful flycheck-posframe flycheck yasnippet-snippets yasnippet company-lsp lsp-ui lsp-mode company-quickhelp company-box company rotate eyebrowse smartparens drag-stuff expand-region all-the-icons-dired dired-k treemacs-persp treemacs-magit treemacs-icons-dired treemacs-projectile treemacs-evil treemacs goto-line-preview exec-path-from-shell avy all-the-icons-ivy ivy-prescient ivy-explorer ivy-posframe ivy-rich amx counsel-projectile counsel ivy evil-commentary evil use-package diminish)))
