...
https://github.com/chrismccord/dot_emacs/blob/master/vendor/change-case.el
...
Collection of extensions for proof general
#+BEGIN_SRC emacs-lisp :tangle init.el
...
This is just for its configuration
